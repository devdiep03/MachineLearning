...
heart_disease_model = pickle.load(open(r'C:\Users\hongd\Documents\Zalo Received Files\ML\heart.pkl', 'rb'))
diabetes_disease_model = pickle.load(open(r'C:\Users\hongd\Documents\Zalo Received Files\ML\diabetes.pkl', 'rb'))
kidney_disease_model = pickle.load(open(r'C:\Users\hongd\Documents\Zalo Received Files\ML\kindey.pkl', 'rb'))
...
if selected == 'Diabetes Prediction':
    ...
    if st.button("Diabetes Test Result"):
        ...
        prediction = diabetes_disease_model.predict([user_input])
        if prediction[0]==1:
...
if selected == 'Heart Disease Prediction':
    ...
    if st.button("Heart Disease Test Result"):
        ...
        if '' in user_input:
            ...
            try:
                user_input = [float(x) if x != '' else 0 for x in user_input]  # Handle empty fields gracefully
                user_input = np.array([user_input])  # Reshape to 2D array
                ...
                st.error("Invalid input: Please ensure all fields are numeric.")
